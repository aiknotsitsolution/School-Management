...
router.post("/", authorizeRoles("school_admin", "class_teacher", "staff"), requirePermission("leaves:apply"), ctrl.applyLeave);
router.get("/", authorizeRoles("school_admin", "class_teacher", "staff"), requirePermission("leaves:apply"), ctrl.getLeaves);
